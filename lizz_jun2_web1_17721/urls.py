"""lizz_jun2_web1_17721 URL Configuration
...
admin.site.site_header = "lizz jun2 web1"
admin.site.site_title = "lizz jun2 web1 Admin Portal"
admin.site.index_title = "lizz jun2 web1 Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="lizz jun2 web1 API",
        default_version="v1",
        description="API documentation for lizz jun2 web1 App",
    ),
    public=True,
